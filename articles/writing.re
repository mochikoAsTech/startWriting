...
サーバが立ち上がってきましたか？それではもう一度SSHでログインしてみましょう。…さっきはログインできたのになぜかできなくなってしまいました。何もしてないのに壊れた！状態ですね。
...
この拡張機能では「prh.yml」というファイルに期待値（expected）や誤りのパターン（pattern）といったルールを書いておきます。
...
同じリズムの平坦な文章が続くと読者の集中力が途切れてしまいます。楽しく読めるコラムや会話形式、イラストといったアクセントをつけることで読者の意識を引き戻しましょう。そう、たとえばこんな風に…
