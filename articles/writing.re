...
//footnote[classmethod][クラスメソッドさんのDevelopersIOは、1年以上前の記事には「この記事は公開されてから1年以上経過しています。情報が古い可能性がありますので、ご注意ください。」という案内が自動で表示されるところが素晴らしいなと思います。]
...
また英数字の羅列だと覚えにくいけれど何の略なのかわかれば理解しやすくなる、という側面もありますので、次のようにはじめは正式名称で紹介して、以降は略語にする形もよいでしょう。読み方がわからずにひそかに悩んでしまう@<fn>{k8s}のも初心者あるあるですので、次のようにカタカナで読み仮名も添えるとなお親切です。
...
長い…！実際に声に出して読んでみるとわかりますが、この長さだとひといきでは読めず途中で息が切れてしまいます。あくまで目安ですが@<ttb>{ひとつながりの文章で50文字を超えたら「。」で区切りましょう}。前述の文章を適切な長さで区切ると次のようになります。
...
筆者が「渾身の出来！」と思っても、想定する読者層が「わかりやすい！」と思ってくれなければただの独りよがりになってしまいます。

文章を読むときはいったん自分が書き手であることは忘れて、脳内に用意した仮想の読者に読んでもらうようにしましょう。筆者の場合は「エンジニアとして勉強を始めたころの自分」を仮想読者として脳内に保っています。

=== 読者の歩幅に合わせよう

筆者は大きな駅でよく迷子になります。「大江戸線はこちら」と書いてある看板の矢印に従って角を曲がっても、そこに次の案内はなく「大江戸線！どこ！！」となるのです。同じことは文章でも起こります。説明という飛び石の間隔が読者の歩幅に合っていないと、読者は次の石がどこにあるのかわからなくて立ち尽くしてしまうのです。
